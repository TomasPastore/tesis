...
2) Run an specific driver.py function previously set in main() function
 manually:
    **python src/main.py**  
...
├── requirements.txt
└── src
    ├── artifacts.py      # Filters FRonO 300 HZ and RonO 180 HZ elec artifacts
    ...
    ├── FRonO_paper.py                                       # Name descriptive
